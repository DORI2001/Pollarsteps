...
2. Create new repository: `polarsteps`
...
# Make first commit
git commit -m "Initial commit: Polarsteps travel tracking app"

# Add remote (replace YOUR_USERNAME with your GitHub username)
git remote add origin https://github.com/YOUR_USERNAME/polarsteps.git
...
# Should show:
# origin  https://github.com/YOUR_USERNAME/polarsteps.git (fetch)
# origin  https://github.com/YOUR_USERNAME/polarsteps.git (push)
```

### Step 4: Optional - Add Topics & Description

On GitHub repository page:
- **About section**: Add description
- **Topics**: Add `travel`, `mapbox`, `fastapi`, `next-js`, `full-stack`
- **Add**: README badge status
